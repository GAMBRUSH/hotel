...
// URL
$regis_url = 'https://iphone-xml.booking.com/json/mobile.createUserAccount?&user_os=7.1.2&user_version=22.9-android&device_id=aa7bf591-e6dd-419a-8a4f-29e762d8948a&network_type=wifi&languagecode=en-us&display=large_mdpi&affiliate_id=337862';
...
// Wishlist
$create_wishlist = json_encode(array("wishlist_action" => "create_new_wishlist", "name" => "Jakarta", "hotel_id" => "28250", "auth_token" => $register['auth_token']));
...
if($create['success'] == '1'){
	...
	foreach ($hotel as $hotel_id) {
		$add_wishlist = json_encode(array("wishlist_action" => "save_hotel_to_wishlists", "new_states" => 1, "list_ids" => $create['id'], "hotel_id" => $hotel_id, "list_dest_id" => "city%3A%3A-2679652", "update_list_search_config" => 1, "checkin" => "2020-07-27", "checkout" => "2020-07-28", "num_rooms" => 1, "num_adults" => 2, "num_children" => 0, "auth_token" => $register['auth_token']));
